...
-- cost 6 billones...
#esta consulta consime mas recursos ya que la tabla no tiene primari key y foreing key asi que es mas conplejo
...
#creamos las tablas pero sin las llaves, al hacer una consulta va a consumir mas recursos 
